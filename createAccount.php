        ...
        <div class="body">
            <form id="sign_in" method="POST"  name="mainForm">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <input  type="text" class="form-control" ng-model="student.username" name="username" placeholder="username" required autofocus>
                    </div>
                </div>
                <div class="input-group">
                    <span class="input-group-addon">
                ...
                <div class="row text-center">
                    <div class="col-xs-12 text-center">
                        <input class="btn btn-block bg-grey waves-effect" type="submit" id="loginButton" value="Create Account"
                               ng-disabled="mainForm.$invalid" ng-click="create(user)"/>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    app.controller('formCtrl', function($scope,$http,$window) {
        ...
        $scope.create=function(student) {
            ...
            let settings = {
                "url": "<?php echo $backendServer; ?>open/createAccount",
                "method": "POST",
                "timeout": 0,
                "headers": {
